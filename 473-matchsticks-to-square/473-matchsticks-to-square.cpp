 bool backtrack(vector<int>& matchsticks,int index,int a,int b,int c,int d)
    {
        ...
        {
            a=a-matchsticks[index];
            
            if(backtrack(matchsticks,index,a,b,c,d))
                return true;
